					...
					<div class="col-md-7">
						...
						<div class="billing-details">
							...
							<div class="form-group">
								<input class="input" type="email" name="email" value="<%=request.getAttribute("email") %>" readonly="readonly">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<input class="btn btn-danger" type="submit" name="action" value="Reset Password">
							</div>
							</form>
						</div>
						<!-- /New  password Details -->
