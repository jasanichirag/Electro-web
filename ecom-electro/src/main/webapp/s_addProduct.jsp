				...
				<div class="row">
					...
					<div class="col-md-7">
						...
						<div class="billing-details">
							...
							%>
							<form action="ProductController" name="AddProduct" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
								<input class="input" type="text" name="pname" placeholder="Product Name" required="required">
							</div>
							<div class="form-group">
								<input class="input" type="text" name="pbrand" placeholder="Product Brand Name"required="required">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<input class="input" type="number" name="price" placeholder="Product Price" required="required">
							</div>
							<div class="form-group">
								<input class="input" type="number" name="punit" placeholder="Product Unit" required="required">
							</div>
							<div class="form-group">
<textarea rows="4" cols="10" placeholder="Product Discription" required="required" class="input" name="pdisc"></textarea>
							</div>
							<div class="form-group">
