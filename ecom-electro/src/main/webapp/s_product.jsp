				...
				<div class="row">
					...
					<div class="col-md-5">
						<div class="product-details">
							...
							<div>
								<h3 class="product-price">Rs : <%=p.getPrice() %>/-</h3>
								<br>
							</div>
							<p><%=p.getPdisc() %></p>
							...
							<div class="add-to-cart">
								...
								<b>Qty</b>	
									<div class="input-number">
										<input type="number" value="<%=p.getPunit()%>" readonly="readonly">
									</div>
								</div>
								
							</div>
							<div class="add-to-cart">							
								<a href="s_editProduct.jsp?pid=<%=p.getPid()%>"><input type="submit" name="action" value="Edit Product" class="btn btn-primary"></a>
						<a href="s_deleteProduct.jsp?pid=<%=p.getPid()%>"><input type="submit" name="action" value="Delete Product" class="btn btn-danger" style="margin: 5px"></a>
								</div>
						...
						<div class="row">
							<div class="products-tabs">
								...
								<div id="tab1" class="tab-pane active">
									...
									for(ProductBean p1:list){
										%>
										<!-- product -->
										<div class="product">
											<div class="product-img">
											<a href="s_product.jsp?pid=<%=p1.getPid()%>"><img src="Product_Images/<%=p1.getImage() %>" alt="image" style="width: 100%;height:6cm"></a>
											</div>
											<div class="product-body">
												<p class="product-category"><%=p1.getCategory() %></p>
												<h3 class="product-name"><a href="s_product.jsp?pid=<%=p1.getPid()%>"><%=p1.getPname() %></a></h3>
												<h4 class="product-price">Rs.<%=p1.getPrice() %>/-</h4>
												<div class="product-rating">
													<i class="fa fa-star"></i>
													<i class="fa fa-star"></i>
													<i class="fa fa-star"></i>
