					...
					<div class="billing-details">
						...
						<table class="table table-hover">
							...
							<tbody>
								...
								<tr>
									<th scope="row">
									<a href="product.jsp?pid=<%=p.getPid()%>"><img alt="image"
										src="Product_Images/<%=p.getImage()%>" style="width: 60px"></a>
									</th>
									<td><a href="product.jsp?pid=<%=p.getPid()%>"><b><span style="color: red"><%=p.getCategory()%></span><br><%=p.getPname()%></b>
									</a></td>
									...
									<h5>
											<input type="number" value="<%=c.getQnt()%>" min="1"
												max="10" style="padding: 5px" name="qnt" onchange="this.form.submit();">
										</h5> 
									</form>
									</td>
				...
				<div class="col-md-5 order-details">
					...
					<div class="order-summary">
						...
						for(MyCartBean c:list){
							...
							%>
							<div class="order-col">
								<div><%=c.getQnt()%>x <%=p.getPname() %></div>
								<div><a>Rs.</a><%=c.getTprice() %>.00</div>
							</div>
							<%
						}
						%>
						...
						<div class="order-col">
							...
							<div>
								<strong class="order-total">Rs.<%=G_total %>.00/-</strong>
							</div>
						</div>
					</div>
